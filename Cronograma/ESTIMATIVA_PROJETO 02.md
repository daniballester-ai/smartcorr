...
- [X] **Feature Selection:** Remover ruído e focar nas variáveis de impacto.
- [X] **Modelo Final:** Retreinar com dados novos e tunar performance.
...
- [X] **SQL Write-back:** Criar script/job para inserir as previsões (`predictions.csv`) de volta em uma tabela do SQL Server (`tb_SmartCorr_Predictions`) para consumo do BI.
...
* **Gestão de Variáveis:** A incorporação de "Novas variáveis" será **gradual e contínua**, condicionada à entrega de mapeamentos de outros projetos de BI. O modelo evoluirá versões para absorver novos inputs assim que disponíveis.
